...
Package path: ``lab_model.language.primitives`` — the only primitive/command layer.
...
(``GET_TUNABLES``, ``GET_MEASURABLES``, ``GET_PARAMETERS``) use
``fetch_read_primitive`` with GET routes.
"""
