"""APPLY_TUNABLES_PATCH macro â€” bulk commit with fixed step ordering.
...
Ordering (documented; do not reorder without updating this file):
  ...
  4. Motion / holding primitives last (pick, hover, place) â€” **not** applied
...
async def run_apply_tunables_patch(
    lab: Any, cmd: ApplyTunablesPatchBody
) -> None:
    tid = cmd.target_id
    ...
    # Step 4 (motion) intentionally omitted â€” use explicit primitives.
