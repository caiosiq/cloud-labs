...
PRIMITIVE_REGISTRY: Dict[PrimitiveId, Dict[str, Any]] = {
    ...
    PrimitiveId.GET_PARAMETERS: {
        "kind": PrimitiveKind.ATOMIC,
        "read_only": True,
        "handler": "return_parameters_for_tag",
        "http": "GET /api/components/{tag_id}/parameters",
        "notes": "Catalog-authored static identity; not mutated by motion primitives.",
    },
