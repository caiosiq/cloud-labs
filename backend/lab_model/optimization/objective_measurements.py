...
from lab_model.optimization.paths import component_entry
from lab_model.optimization.spec import ObjectiveSpec, ObjectiveTermSpec
    ...
    *,
    ...
    for plan in plans:
        if plan.kind == "derived_centroid":
            ...
            from lab_model.optimization.metrics.image_features import compute_beam_centroid_px
        ...
        if (
            ...
            bgr = _bgr_for(capture_tag)
            from lab_model.optimization.metrics.image_features import compute_beam_power_scalar
