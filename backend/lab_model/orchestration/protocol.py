...
class OptimizeHost(StateHost, Protocol):
    ...
    async def _primitive_optimize_component(
        ...
        *,
        ...
        strategy_name: str,
        params: Dict[str, Any],
        live_pose_callback: Any,
    ) -> Optional[Dict[str, Any]]: ...

    def _begin_optimize_live_session(self, tag_id: str, initial_pose: Dict[str, Any]) -> None: ...
    def _optimize_live_pose_update(self, tag_id: str, pose: Dict[str, Any]) -> None: ...
