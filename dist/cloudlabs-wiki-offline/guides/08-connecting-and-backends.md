...
- **Wiki → Backends** — gallery of labs; open one for overview, components, kernels,
  and frozen **Snapshots** (pins).
- Twin still publishes commits; approve (when needed) under that backend’s Snapshots tab.
