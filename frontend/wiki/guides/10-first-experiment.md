...
family scripts use. When a layout is worth keeping, use the Twin control graph
to **commit** it (see [Version control and lab history](#)).
...
| Commits, stash, pins | Learn → *Version control and lab history* |
