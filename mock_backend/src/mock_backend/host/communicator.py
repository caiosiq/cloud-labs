...
class MockLabCommunicator(LabCommunicator):
    ...
    **Z convention** (see ``new_primitives.md`` "Z / coordinate convention"):
    ...
    def __init__(self):
        ...
        from mock_backend.host.persistence import read_state
    ...
    def _edge_data_root(self) -> Optional[Path]:
        """``mock_backend/cloudlabs_edge`` when present beside this package."""
    ...
    def _ensure_state(self):
        ...
        """
        from mock_backend.host.persistence import ensure_state_file
    ...
    def _write_state(self, state: Dict[str, Any]):
        ...
        """
        from mock_backend.host.persistence import write_state
    ...
    def refresh_pose_from_camera(
        ...
        from mock_backend.shared.mock_scan_preview import (
    ...
    async def _primitive_move_component(
        ...
        from mock_backend.host.primitives import primitive_move_component
    ...
    async def _primitive_move_motor(
        ...
        from mock_backend.host.primitives import primitive_move_motor
    ...
    async def _primitive_optimize_component(
        ...
        *,
        ...
        from mock_backend.host.primitives import primitive_optimize_component
    ...
    async def _primitive_add_component_to_state(
        ...
        from mock_backend.host.primitives import primitive_add_component_to_state
    ...
    async def _primitive_reactivate_off_table_component(
        ...
        from mock_backend.host.primitives import primitive_reactivate_off_table_component
    ...
    async def _primitive_pick_component(
        ...
        from mock_backend.host.primitives import primitive_pick_component
    ...
    async def _primitive_hover_component(
        ...
        from mock_backend.host.primitives import primitive_hover_component
    ...
    def get_table_cam_stream(self, cam_id: int = 1, fps: int = 18):
        ...
        while True:
            ...
            if not self._table_cam_connected.get(cid):
                ...
                from mock_backend.host.mock_beam_frame import render_mock_beam_frame

                frame = render_mock_beam_frame(ts, cam_id=cid, width=480, height=360)
    ...
    async def _primitive_record_measurables(
        ...
        from mock_backend.host.primitives import primitive_record_measurables
