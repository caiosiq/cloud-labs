...
# MuJoCo overlay parked outside mock_edge for this cut (Phase 2 mock-only).
...
class RuntimeLabProxy:
        ...
        return {
            ...
            "available_modes": [
                {"id": "mock", "label": "Mock UI", "enabled": True},
                {
                    ...
                    "enabled": False,
                    "reason": "MuJoCo overlay not shipped in mock_edge v1",
                },
                {
                    "id": "physical",
    ...
    def switch_mode(self, requested_mode: str) -> Dict[str, Any]:
        ...
        try:
            if mode == "mujoco":
                raise RuntimeModeError(
                    "MuJoCo overlay is not available in mock_edge v1 "
