...
class ComponentProxy:
    ...
    def probe_kernel(self, field: str, *, kernel_id: str) -> Union[float, List[float]]:
        """Authoring probe via EVAL_KERNEL (kernels are inputs, not peer verbs)."""
        return self.client.probe_kernel(self.tag_id, field, kernel_id=kernel_id)

    def eval_kernel(self, field: str, *, kernel_id: str) -> Union[float, List[float]]:
        """Deprecated alias for :meth:`probe_kernel`."""
