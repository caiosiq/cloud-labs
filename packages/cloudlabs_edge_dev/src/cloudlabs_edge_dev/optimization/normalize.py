"""Unit-hypercube normalization for edge optimization search vectors."""
...
class _HasBounds(Protocol):
    ...
    @property
    def bounds(self) -> Any: ...  # noqa: ANN401

    @property
    def delta(self) -> bool: ...


# Avoid circular import typing — accept duck-typed pipeline variables.
