...
Usage (from repository root):
  ...
  python scripts/create_lab_communicator.py my_backend
  python scripts/create_lab_communicator.py my_backend --with-lab-view
  python scripts/create_lab_communicator.py my_backend --with-lab-view --lab-view-root backend/lab_communicator/my_backend/lab_view
