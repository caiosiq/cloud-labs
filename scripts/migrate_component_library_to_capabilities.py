...
Usage::
    ...
    python scripts/migrate_component_library_to_capabilities.py

    # Migrate a specific path
    python scripts/migrate_component_library_to_capabilities.py PATH [PATH ...]

    # Force regeneration of capabilities (drop any hand-edits)
    python scripts/migrate_component_library_to_capabilities.py --force

    # Dry-run (print resulting JSON, don't write)
    python scripts/migrate_component_library_to_capabilities.py --dry-run
"""
...
from lab_communicator.shared.catalog_schema import (  # noqa: E402
