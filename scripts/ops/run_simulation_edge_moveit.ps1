...
$env:SIMULATION_EDGE_PLANNER = "moveit"
...
$env:CLOUDLAB_MOVEIT_MAX_VELOCITY_SCALE = Format-EnvFloat (0.35 * $Speed)
$env:CLOUDLAB_MOVEIT_MAX_ACCELERATION_SCALE = Format-EnvFloat (0.35 * $Speed)
$env:CLOUDLAB_MOVEIT_TRAJECTORY_TIME_SCALE = Format-EnvFloat (0.5 / $Speed)
$env:CLOUDLAB_MOVEIT_PREPICK_FEASIBILITY_SEEDS = "10"
$env:CLOUDLAB_MOVEIT_PREPICK_FEASIBILITY_TIMEOUT_S = "150"
