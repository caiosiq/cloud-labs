"""TorchScript-shaped kernel host for the simulation edge (stub)."""
...
def load_kernel(kernel_id: str) -> Any:
    ...
    if kernel_id not in _CACHE:
        _CACHE[kernel_id] = {"kernel_id": kernel_id, "kind": "sim_stub"}
...
def eval_on_bgr(
    ...
    *,
    ...
    """Score a BGR frame with a deterministic stub."""
    _ = args
